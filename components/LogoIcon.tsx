...
// Части знаков несут lg-* классы: при data-logofx='anim' на <html> CSS
// оживляет их (мерцание звезды, пульс лучей, полёт спутника, качание месяца).
export const LOGO_ICONS: Record<string, Mark> = {
  ...
  dawn: () => (
    <svg viewBox="0 0 24 24" {...stroke}>
      ...
      <path className="lg-ray" d="M12 8.6V6.2" />
      <path className="lg-ray" style={{ animationDelay: '0.45s' }} d="M6.9 10.7 5.2 9" />
      <path className="lg-ray" style={{ animationDelay: '0.9s' }} d="M17.1 10.7 18.8 9" />
    </svg>
  ),
